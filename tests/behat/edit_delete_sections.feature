@format @format_drip
Feature: Sections can be edited and deleted in drip format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete driptopics
  ...
  Scenario: View the default name of the general section in drip format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in drip format
    When I edit the section "0" and I fill the form with:
      | Custom | 1                     |
      | New value for Section name      | This is the general section |
    Then I should see "This is the general section" in the "li#section-0" "css_element"

  Scenario: View the default name of the second section in drip format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in drip format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "li#section-2" "css_element"

  Scenario: Edit section default name in drip format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
      | New value for Section name      | This is the second driptopic |
    Then I should see "This is the second driptopic" in the "li#section-2" "css_element"
    And I should not see "Topic 2" in the "li#section-2" "css_element"

  @javascript
  Scenario: Inline edit section name in drip format
    When I click on "Edit driptopic name" "link" in the "li#section-1" "css_element"
    And I set the field "New name for driptopic Topic 1" to "Midterm evaluation"
    And I press key "13" in the field "New name for driptopic Topic 1"
    Then I should not see "Topic 1" in the "region-main" "region"
    And "New name for driptopic" "field" should not exist
  ...
  Scenario: Deleting the last section in drip format
  ...
  Scenario: Deleting the middle section in drip format
