...
/**
 * Drip course format related unit tests.
 *
 * @package   format_drip
...
final class format_drip_test extends \advanced_testcase {
    ...
    public function test_get_section_name(): void {
        ...
        $numsections = 5;
        $course = $generator->create_course(['numsections' => $numsections, 'format' => 'drip'],
            ['createsections' => true]);
    ...
    public function test_update_inplace_editable(): void {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'drip'],
            ['createsections' => true]);
    ...
    public function test_inplace_editable(): void {
        ...
        $tmpl = component_callback('format_drip', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
    ...
    public function test_default_course_enddate(): void {
        ...
        $params = ['format' => 'drip', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url(): void {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(['format' => 'drip']);
